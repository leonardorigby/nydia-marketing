...
import '../styles/components/TableItems.css';
  ...
  return (
    <div className={classes.root}>
      <Paper className={classes.paper}>
        <EnhancedTableToolbar numSelected={selected.length} componentName={props.componentName}/>
        <TableContainer>
          <Table
              ...
              {stableSort(props.data, getComparator(order, orderBy))
                ...
                let dataKeys = Object.keys(row);
                  ...
                  : <TableCell align="left" key={index}>{row[service]}</TableCell>
                        ...
                        const isItemSelected = isSelected(row.empresaRazonSocial);
                        ...
                        {/* <TableCell align="center">{value}</TableCell> */}
                            ...
                            <TableCell align="center">{row.correoEmpresarial}</TableCell>
                            <TableCell align="center">{row.empresaRazonSocial}</TableCell>
                            <TableCell align="center">{row.telefono}</TableCell>
                            <TableCell align="center">{row.urlImage}</TableCell> */}
                          </TableRow>
                        );
                })}
              {emptyRows > 0 && (
